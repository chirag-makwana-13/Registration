...
router.use('/profile',require('../controller/profile/profile'))
    ...
    router.use('/attendance', authMiddleware,require('../controller/attendance/attendance'))
    router.use('/delimeter', authMiddleware,require('../controller/delimeter/delimeter'))
    router.use('/grid', authMiddleware,require('../controller/grid/grid'))
    
    //----------------Job Application Form--------------
    router.use('/jobapplicaiton', authMiddleware,require('../controller/jobapplicaiton/jobapplicaiton'))
